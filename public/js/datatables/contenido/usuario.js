                ...
                <table id="services_table" class="table table-row-dashed">
                    ...
                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="text-center col-3 p-0 ps-2">ESTADO${
                                credenciales['Grupo'].puedeRegistrar
...
function AgregarTR(nombre, id, fecha, titulo){
    ...
    var className = (credenciales['Grupo'].puedeEliminar)? 'editar-acceso': 'disabled';
    var html =`<tr>
        ...
        init: function(data){
            ...
            for (const key in data) {
                if (data.hasOwnProperty(key)) {
                    var className = (credenciales['Usuario'].puedeEliminar)? 'estado-usuario': 'disabled';
                    ...
                    var rowNode =  miTabla.row.add( {
                                        ...
                                        "3": data[key].Email,
                                        "4": btnEstado,
                                        "5": botonAcciones('registrar',data[key].Id,'Usuario'),
                                        "6": (credenciales['Grupo'].puedeVer)?botonVerDetalle('Grupos Asociados'):null
                                    } ).node();
...
KTUtil.onDOMContentLoaded((function() {
    (credenciales['Usuario'].puedeVer)?cargarData.init(data):null;

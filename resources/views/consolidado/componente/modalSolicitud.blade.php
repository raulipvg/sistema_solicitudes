<div class="modal modal-xl fade" tabindex="-1" id="solicitudes" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
    <div class="modal-dialog mt-20">
        <div class="modal-content" id="div-bloquear">
            <div class="modal-header bg-light p-2 ps-5">
                <h2 id="modal-titulo-historialSolicitud" class="modal-title text-uppercase">Solicitudes Asociadas</h2>
                <!--begin::Close-->

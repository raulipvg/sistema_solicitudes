...
@push('Script')
    ...
    <script src="{{ asset('js/datatables/contenido/consolidado_detalle.js?id=9') }}"></script>
    ...
    <script src="{{ asset('js/global/main.js?id=89') }}"></script>
    <script src="{{ asset('js/eventos/consolidado/consolidado.js?id=9') }}"></script>

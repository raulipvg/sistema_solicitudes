<div class="modal fade" tabindex="-1" id="registrarEstado" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
    <div class="modal-dialog mt-20">
        <div class="modal-content" id="div-bloquear">
            <div class="modal-header bg-light p-2 ps-5">
                <h2 id="modal-titulo" class="modal-title text-uppercase">Registrar Estado</h2>
            ...
            <form id="FormularioEstadoFlujo" action="" method="post">
                ...
                <div class="modal-footer bg-light p-2">
                    ...
                    <button id="AddSubmitEstado" type="submit" class="btn btn-success">
                        <div class="indicator-label">Registrar</div>
                        <div class="indicator-progress">Espere...
                            <span class="spinner-border spinner-border-sm align-middle ms-2"></span>
                        </div>
                    </button>
                    <button id="EditSubmitEstado" type="submit" class="btn btn-success">

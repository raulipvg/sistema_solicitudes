...
@push('Script')
	...
	<script src="{{ asset('js/datatables/datatables.bundle.js?id=4') }}"></script>
    <script src="{{ asset('js/datatables/language/language_es.js?id=4') }}"></script>
	<script src="{{ asset('js/datatables/contenido/solicitud_activa.js?id=4') }}"></script>
	<script src="{{ asset('js/datatables/contenido/solicitud_terminada.js?id=4') }}"></script>
	...
	<script src="{{ asset('js/eventos/solicitud/generales.js?id=5') }}"></script>
	@endif
	@if ($credenciales['realizar'])
	<script src="{{ asset('js/flatpickr/es.js?id=5') }}"></script>
	<script src="{{ asset('js/eventos/solicitud/crearsolicitud.js?id=5') }}"></script>
	@endif
	<script src="{{ asset('js/eventos/solicitud/historialsolicitud.js?id=5')}}"></script>
    <script src="{{ asset('js/eventos/solicitud/verflujo.js?id=5')}}"></script>
